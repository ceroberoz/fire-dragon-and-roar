 <section id="imade-header">  
    ...
    <div class="imade-box">
        <div id="find">
          <h1 style="font-size:35px;"><img class="hidden-xs" style="margin-top:-15px;" src="<?php echo base_url();?>/assets/ipapa/images/mark_home.png" alt="brand"> 
          TEMUKAN KANTOR UNTUK DISEWA!</h1>
        </div>
        ...
        <div class="radiotabs clearfix">
            <ul class="tabs">
              <li>
                ...
                <label for="tab1">Gedung</label>
              </li>
              <li class="hidden-xs">
                <input type="radio" name="tabs" id="tab2" value="map" onclick="window.location='/id/building/map';">
                <label for="tab2">Peta</label>
              </li>
            </ul>
        </div>
        ...
        <div class="imade-box-inner col-lg-11 col-md-11">
                ...
                <div style="text-align:center" class="hidden-lg hidden-md col-sm-12 col-xs-12">
                   <button class="button margtop10" type="submit">Cari</button>
                </div>
        ...
        <div style="text-align:center" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          ...
          <h3 class="ava-office">+62 21 300 66 511 &nbsp; &bull; &nbsp; info@ipapa.co.id</h3>
        </div>          
...
<div id="container-feature" class="clearfix">
  <div class="feature-building">
    ...
    <ul>
     <li class="feature"><a class="feature" href="<?php echo base_url();?>id/building/detail/prima-1-59">Menara Prima</a></li>
     <li class="feature"><a class="feature" href="<?php echo base_url();?>id/building/detail/dea-1-55">Menara Dea</a></li>
     <li class="feature"><a class="feature" href="<?php echo base_url();?>id/building/detail/noble-house-52">Noble House</a></li>
     <li class="feature"><a class="feature" href="<?php echo base_url();?>id/building/detail/artha-graha-106">Artha Graha</a></li>
     <li class="feature"><a class="feature" href="<?php echo base_url();?>id/building/detail/plaza-oleos-147">Plaza Oleos</a></li>
   </ul>
    </div>
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
      <ul>
      <li class="feature"><a class="feature" href="<?php echo base_url();?>id/building/detail/18-office-park-380">18 Office Park</a></li>
      <li class="feature"><a class="feature" href="<?php echo base_url();?>id/building/detail/chase-plaza-98">Chase Plaza</a></li>
      <li class="feature"><a class="feature" href="<?php echo base_url();?>id/building/detail/ad-premier-140">AD Premier</a></li>
      <li class="feature"><a class="feature" href="<?php echo base_url();?>id/building/detail/lippo-kuningan-35">Lippo Kuningan</a></li>
      <li class="feature"><a class="feature" href="<?php echo base_url();?>id/building/detail/antam-building-148">Antam Building</a></li>
    </ul>
    </div>
    <div class="col-lg-4 col-md-4 col-sm-4 hidden-xs">
      <ul>
      <li class="feature"><a class="feature" href="<?php echo base_url();?>id/building/detail/menara-rajawali-57">Menara Rajawali</a></li>
      <li class="feature"><a class="feature" href="<?php echo base_url();?>id/building/detail/mayapada-tower-2-162">Mayapada Tower 2</a></li>
      <li class="feature"><a class="feature" href="<?php echo base_url();?>id/building/detail/m-gold-tower">M Gold Tower</a></li>
      <li class="feature"><a class="feature" href="<?php echo base_url();?>id/building/detail/h-tower-249">H Tower</a></li>
      <li class="feature"><a class="feature" href="<?php echo base_url();?>id/building/detail/plaza-great-river-51">Plaza Great River</a></li>
    </ul>
    </div>
...
<div id="client-services">
  <div class="client">
    <div style="text-align:center"  class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
      <h3 class="yourbussiness">CIPTAKAN BISNISMU!</h3>
      <p class="intro">Ipapa adalah sebuah <i>E-Building Marketing</i> dan Konsultansi, Ipapa berkomitment untuk menjadi media online untuk memenuhi kebutuhan anda dalam menemukan ruang kantor yang cocok untuk anda dan jenis bisnis anda.</p>
    </div>
   ...
   <div style="text-align:center" id="padding-btn" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
      <a class="service-btn" href="<?php echo base_url();?>services"><small>LAYANAN KAMI</small></a>
   </div>
...
<div class="container-testi col-lg-12 col-md-12 col-sm-12 hidden-xs clearfix">
  <center><h3 class="customersay">KATA MEREKA IPAPA ITU...</h3>
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
      ...
      <center>
        <div class="imagetesti">
         <img class="img-circle img-responsive" src="<?php echo base_url();?>/assets/ipapa/images/default_user.png" alt="img-default-user" width="60" height="60" >
        </div>
      </center>
