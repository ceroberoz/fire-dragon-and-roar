<div id="col-map">
    ...
    <div class="building-map">
      ...
      <?php endforeach;
		...
		?>
      <div class="near-building-box">
        <div class="img-building">Search not found</div>

        <div class="info-near-building">
          <div class="info-left">
            <h1 class="building-name"> </h1>
			<h3 class="building-location"><i class="fa fa-map-marker"></i></h3>
          </div>
          <div class="info-right">
            <h3 class="building-price"></h3>
          </div>
        </div>
...
var map;
   ...
   // Tambahkan Marker 
    ...
    <?php foreach ($result as $building):
      ...
      $price = json_encode($building->f_br_typical);
    ?>
