  ...
  <div class="container-building">
    <div class="row">
      ...
      <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
        <h3 class="judul"><a href="<?php echo base_url();?>building/detail/<?php $name = $list->s_building_name;
                 $lowcaps = strtolower($name);
                 $underscr = str_replace(' ', '-', $lowcaps);
...
;?></i><small class="facilities"> Musholla</small>
      ...
      <div class="col-lg-3 col-md-2 col-sm-2 hidden-xs padtop30">
        <center>
        <a class="matthew" data-toggle="modal" data-target="#modal-login">Contact Building Management</a>
        </center>
      </div>
  ...
  <?php } else { ;?>
    <div class="container-building">
    <div class="row">
      <center><p>no building available in the area</p></center>
  </div>
</div>
  <?php } ;?>
</div>
