...
<section>
      <div class="pesan">
  <div class="isi alert alert-success">
               <span class="glyphicon glyphicon-ok"></span> <strong>Subscribe Creation Successful.</strong>
                <hr class="message-inner-separator">
                <p>You've already registered your email at <?php echo $pocky;?> as our newsletter subcriber. We will send you an email about the available office space in Jakarta.</p>
            </div>
