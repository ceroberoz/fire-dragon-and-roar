...
<head>
    ...
    if($this->uri->segment(2) == "detail"){
        ...
        <?php foreach($metas as $meta):?>
            <meta name="description" content="<?php echo $meta->s_seo_meta_description_en;?>">
...
office space for lease,jakarta,design interior,office decor,building,business location";?>">
            ...
            <link rel="canonical" href="<?php echo base_url();?>building/detail/<?php $name = $meta->s_building_name;
        ...
        <?php endforeach;?>
    <?php } }
    elseif($this->uri->segment(1) == "furniture"){
        ;?>
...
<?php } elseif($this->uri->segment(1) == "decoration"){ ;?>
