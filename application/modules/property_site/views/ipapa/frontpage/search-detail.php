    ...
    <div style="padding-top:10px; padding-bottom:5px;" class="container">
      <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
               <h1 class="judul"><a href=""><?php echo $detail->s_building_name;?></a> Office Space For Rent</h1>
                                    ...
                                    <div class="row">
                                        <div id="property-slider" class="clearfix">
                                            <div class="flexslider">
                                                ...
                                                <?php } else { ;?>
                                                  <li><img alt="<?php echo $detail->s_building_name;?>" src="<?php echo base_url();?>/assets/ipapa/images/640x480.png"></li>
                                                <?php } ;?>
                                                </ul><!-- end slides -->
                                            </div><!-- end flexslider -->
...
<div class="shareon">
  <span>Share On:</span>
    ...
    <a href="javascript:twShare('<?php echo base_url();?>building/detail/<?php $title = $detail->s_building_name; $lowcaps = strtolower($title); $underscr = str_replace(' ', '-', $lowcaps); echo $underscr;?>-<?php echo $detail->pk_building_id;?>', '<?php echo $detail->s_building_name;?>', '<?php echo strip_tags(substr($detail->s_description_en,0,180));?>', '', 520, 350)"><img src="<?php echo base_url();?>assets/ipapa/images/twitter.png" width="26" height="26"></a>
  ...
  <div class="pull-right">
    <a class="addas" href=""><i class="fa fa-star"></i> Add as favorite</a><a href="<?php echo base_url(); ?>building/printpdf"><i class="fa fa-print"></i> Print a page</a>
  </div>
</div>
                                            ...
                                            <td class="col-md-4">
                                             ...
                                             <div style="display:none;">
                                              ...
                                              <td>
                                                ...
                                                <div class="text-right"><strong class="text-success"> Available</strong> </div>
