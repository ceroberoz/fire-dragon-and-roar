...
<body>
  <div class="wrap">
	...
	<div class="header_bottom">
	     	<div class="menu">
	     		<ul>
			    	<li><a href="<?php echo base_url(); ?>ifurniture">Home</a></li>
			    	<li><a href="<?php echo base_url(); ?>ifurniture/furniture">Furniture</a></li>
			    	<li class="active"><a href="<?php echo base_url(); ?>ifurniture/decoration">Decoration</a></li>
 ...
 <div class="main">
    <div class="content">
    	<div class="content_top">
    		...
    		<div class="see">
    			<p><a href="<?php echo base_url(); ?>ifurniture/furniture">See all Office Decoration Ideas</a></p>
    		</div>
    		<div class="clear"></div>
    	</div>
	      <div class="section group">
				...
				<div class="grid_1_of_4 images_1_of_4">
					<a href="#"><img src="<?php echo base_url(); ?>/assets/ifurniture/images/decorations/generali/3.jpg" alt="" /></a>
					 <h2>Meeting Room</h2>
					 <div class="price-details">
				       <div class="price-number">
							<p><span class="rupees"></span></p>
				...
				<div class="grid_1_of_4 images_1_of_4">
					<a href="#"><img src="<?php echo base_url(); ?>/assets/ifurniture/images/decorations/generali/4.jpg" alt="" /></a>
					 <h2>Kitchen Set</h2>
					<div class="price-details">
				       <div class="price-number">
							<p><span class="rupees"></span></p>
		...
		<div class="content_bottom">
    		...
    		<div class="see">
    			<p><a href="<?php echo base_url(); ?>ifurniture/furniture">See all Store Decoration</a></p>
    		</div>
    		<div class="clear"></div>
    	</div>
			<div class="section group">
				...
				<div class="grid_1_of_4 images_1_of_4">
					<a href="#"><img src="<?php echo base_url(); ?>/assets/ifurniture/images/decorations/teradata/2.jpg" alt="" /></a>
					 <h2>Lorem Ipsum is simply </h2>
					 <div class="price-details">
				       <div class="price-number">
							<p><span class="rupees"></span></p>
				...
				<div class="grid_1_of_4 images_1_of_4">
					<a href="#"><img src="<?php echo base_url(); ?>/assets/ifurniture/images/decorations/teradata/3.jpg" alt="" /></a>
					 <h2>Lorem Ipsum is simply </h2>
					<div class="price-details">
				       <div class="price-number">
							<p><span class="rupees"></span></p>
				...
				<div class="grid_1_of_4 images_1_of_4">
				 <a href="#"><img src="<?php echo base_url(); ?>/assets/ifurniture/images/decorations/teradata/4.jpg" alt="" /></a>
					 <h2>Lorem Ipsum is simply </h2>					 
					 <div class="price-details">
				       <div class="price-number">
							<p><span class="rupees"></span></p>
		...
		<div class="content_bottom">
    		...
    		<div class="see">
    			<p><a href="<?php echo base_url(); ?>ifurniture/furniture">See all School Decoration</a></p>
    		</div>
    		<div class="clear"></div>
    	</div>
			<div class="section group">
				<div class="grid_1_of_4 images_1_of_4">
					 <a href="#"><img src="<?php echo base_url(); ?>/assets/ifurniture/images/decorations/decor1.jpg" alt="" /></a>					
					 <h2>Lorem Ipsum is simply </h2>
					<div class="price-details">
				       <div class="price-number">
							<p><span class="rupees"></span></p>
				...
				<div class="grid_1_of_4 images_1_of_4">
					<a href="#"><img src="<?php echo base_url(); ?>/assets/ifurniture/images/decorations/decor2.jpg" alt="" /></a>
					 <h2>Lorem Ipsum is simply </h2>
					 <div class="price-details">
				       <div class="price-number">
							<p><span class="rupees"></span></p>
				...
				<div class="grid_1_of_4 images_1_of_4">
					<a href="#"><img src="<?php echo base_url(); ?>/assets/ifurniture/images/decorations/decor3.jpg" alt="" /></a>
					 <h2>Lorem Ipsum is simply </h2>
					<div class="price-details">
				       <div class="price-number">
							<p><span class="rupees"></span></p>
				...
				<div class="grid_1_of_4 images_1_of_4">
				 <a href="#"><img src="<?php echo base_url(); ?>/assets/ifurniture/images/decorations/decor4.jpg" alt="" /></a>
					 <h2>Lorem Ipsum is simply </h2>					 
					 <div class="price-details">
				       <div class="price-number">
							<p><span class="rupees"></span></p>
