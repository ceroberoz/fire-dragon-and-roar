...
<!DOCTYPE HTML>
<head>
<title>Reset Password - iFurniture</title>
...
<h1 class="account_header"> Forgot password </h1>
<div class="caption">Please submit your registered email address, so that we can send you the password reset link.</div>

				<center><div style="width:200px; margin-top:15px;" class="contact-form ">
