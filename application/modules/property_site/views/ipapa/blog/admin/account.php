...
<?php echo form_open("blog/account/add");?>
      ...
      <div class="modal-body">
                                    ...
                                    <table id="" class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td><img class="circle-image" alt="user image" src="<?php echo base_url();?>assets/uploads/files/default_user.png"> <?php echo $user->username;?></td>
                                            ...
                                            <td> <a href="<?php echo base_url();?>blog/account/edit/<?php echo $user->id;?>" class="btn-app"><i class="fa fa-edit"></i> Edit</a> &nbsp; <a onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo base_url();?>blog/account/delete/<?php echo $user->id;?>" class="btn-app"><i class="fa fa-minus-square"></i> Delete</a></td>
                                        </tr>
                                        <?php endforeach;?>
