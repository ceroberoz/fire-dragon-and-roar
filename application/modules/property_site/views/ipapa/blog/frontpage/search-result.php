        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
                <div class="content-left">
                	<h1 class="arsip">Search Result : <?php echo $keyword;?></h1>
                    <?php 
						if($numRows > 0) {
							echo 'Approximately '.$numRows.' found results ('.round($resultime, 5).' seconds)'; // in seconds
						}else{
							echo 'Search results not found ('.round($resultime, 5).' seconds)'; // in seconds
						}
					?>
                    ...
                    <div class="content-article">
                        ...
                        <div class="isi-article">
							...
							echo $underscr;?>-<?php echo $post->pk_posting_id;?>">
							<?php
                            	$city = array('jakarta'=>'Jakarta','jakarta utara'=>'Jakarta Utara','jakarta selatan'=>'Jakarta Selatan','jakarta barat'=>'Jakarta Barat','jakarta timur'=>'Jakarta Timur','jakarta pusat'=>'Jakarta Pusat','bekasi'=>'Bekasi','bogor'=>'Bogor','tangerang'=>'Tangerang','depok'=>'Depok','bank'=>'Bank','base rent'=>'Base Rent','office'=>'Office','market'=>'Market');
								if(isset($city[$keyword])){
									echo $word = str_replace($city[$keyword],'<span style="background-color: #FFFF00">'.$city[$keyword].'</span>',$post->title);
								}else{
									echo $word = str_replace($keyword,'<span style="background-color: #FFFF00">'.$keyword.'</span>',$post->title);
								}
							?></a></h1>
                            <p class="isi-artikel">
							<?php
								...
								$city = array('jakarta'=>'Jakarta','jakarta utara'=>'Jakarta Utara','jakarta selatan'=>'Jakarta Selatan','jakarta barat'=>'Jakarta Barat','jakarta timur'=>'Jakarta Timur','jakarta pusat'=>'Jakarta Pusat','bekasi'=>'Bekasi','bogor'=>'Bogor','tangerang'=>'Tangerang','depok'=>'Depok','bank'=>'Bank','base rent'=>'Base Rent','office'=>'Office','market'=>'Market');
								if(isset($city[$keyword])){
									$word = str_replace($city[$keyword],'<span style="background-color: #FFFF00">'.$city[$keyword].'</span>',substr($post->description,0,240));
								}else{
									$word = str_replace($keyword,'<span style="background-color: #FFFF00">'.$keyword.'</span>',substr($post->description,0,240));
								}
								echo limit_words($word, $words_limit, ' ... ');
							//echo str_replace($keyword,"<span style='background-color: #FFFF00'>".$keyword."</span>",substr($post->description,0,240));
							?>
                            </p>
