                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="marketing">
                             <ul class="topflags pull-right">
                                <li><a data-placement="bottom" data-toggle="tooltip" data-original-title="English" title="" href="#"><img alt="en" src="<?php echo base_url();?>/assets/ipapa/images/flags/en.png"></a></li>
                                <li><a data-placement="bottom" data-toggle="tooltip" data-original-title="Bahasa" title="" href="#"><img alt="id" src="<?php echo base_url();?>/assets/ipapa/images/flags/id.png"></a></li>
                            </ul>
...
<div class="navbar nav-mobile ">
  ...
  <!--END menu for mobile device -->
    ...
    <div id="usermenu-ipapa" class="hidden-xs">
      <a data-toggle="modal" data-target="#modal-login" class="sign-btn hidden-sm">SIGN IN</a> <a data-toggle="modal" data-target="#modal-register" class="sign-btn">SIGN UP</a>
    </div> 
    <?php } else { ;?>
          <!-- if user login -->
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="<?php
                                $group = array(1, 2);
                            if ($this->ion_auth->in_group($group)){
                                    echo base_url().'management/building';
                                }else{
                                    echo base_url().'members/building';
                                }
                                ;?>"><i class="fa fa-building-o fa-fw"></i>My Building</a></li>
            <li class="divider"></li>
            <li><a href="<?php
                                $group = array(1, 2);
                            if ($this->ion_auth->in_group($group)){
			...
			<li><a href="<?php
                            ...
                            if ($this->ion_auth->in_group($group)){
                                ...
                                ;?>"><i class="fa fa-envelope fa-fw"></i> Messages (<b>3</b>)</a></li>
            <li class="divider"></li>
                        <li><a href="<?php
                                $group = array(1, 2);
                            if ($this->ion_auth->in_group($group)){
