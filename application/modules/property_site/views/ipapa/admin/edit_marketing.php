            ...
            <?php echo form_open_multipart("marketing/building/do_edit");?>
                        ...
                        <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <select name="e_br_currency" class="form-control">
                        ...
                        <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <select name="e_sc_currency" class="form-control">
...
<?php endforeach;?>
        ...
        $("#country_id").change(function(){
                ...
                if (selectValues == 0){
                    var msg = "<select id=\"province_id\" class=\"form-control\" data-style=\"btn-default\" name=\"province_id\" disabled><option value=\"Select Sub-District\">Select City First</option></select>";
                    $('#province').html(msg);
                }else{
                    ...
                    $.ajax({
                            type: "POST",
                            url : "<?php echo site_url('index.php/marketing/building/select_kecamatan')?>",
                            data: country_id,
            ...
            $('body').delegate("#province_id","change", function() {
                ...
                if (selectValues == 0){
                    ...
                    $.ajax({
                            type: "POST",
                            url : "<?php echo site_url('index.php/marketing/building/select_kelurahan')?>",
                            data: province_id,
                            success: function(msg){
                                $('#city').html(msg);
                            }
