            ...
            <aside class="right-side">
             ...
             <?php echo form_open_multipart("admin/office/do_edit");?>
...
<div class="block-inner ">
                  <div class="form-group ">
                    <div class="row">
                      <div class="col-md-5">
                           <?php
					  		if($office->fk_building_id) {
								echo "<select name='o_bid' class='form-control'>";
								echo "<option value='"; echo $office->fk_building_id; echo "' selected='selected'>"; foreach($name as $b): echo $b->s_building_name; endforeach; echo "</option>";
								
								foreach($buildings as $building):
									echo "<option value='".$building->pk_building_id."' >".$building->s_building_name."</option>";
								endforeach;
								echo "</select>";
							}
					  ?>
                      ...
                      <div class="col-md-4">
                       <div class="form-group">
                                        <div class="input-group">
                                           ...
                                           <input name="o_available" type="text" class="form-control" value="<?php echo $office->t_available;?>"data-inputmask="'alias': 'yyyy-mm-dd'" data-mask/>
                                        </div><!-- /.input group -->
                                    </div><!-- /.form group -->
                      </div> 
                      </div>
                      <div class="row">
                          <div class="form-group">
                                <div class="col-md-3">
                                    <input value="<?php echo $office->s_office_floor;?>" type="text" name="o_floor" class="form-control" placeholder="Floor">
                                </div>  
                                <div class="col-md-2">
                                    <input value="<?php echo $office->s_office_unit;?>" type="text" name="o_unit" class="form-control" placeholder="Unit">
                                </div>  

                                <div class="col-md-3">
                                    <div class="input-group col-sm-12">
                                      <input class="form-control" name="o_price" value="<?php echo $office->f_office_price;?>" placeholder="Price">   
                                    </div>
                                </div>
                                <div style="margin-left:-60px;" class="col-md-2">
                                    <select name="o_currecy" class="form-control">
                                            <option value="IDR" <?php if($office->e_currecy = "IDR"){echo "selected";};?>>Rp.</option>
                                            <option value="USD" <?php if($office->e_currecy = "USD"){echo "selected";};?>>US $</option>
                        ...
                        <div class='col-lg-12 col-md-12'>
                            <div class='box'>
                                ...
                                <div class='box-body pad'>
                                        ...
                                        <textarea name="o_desc_en" class="textarea" placeholder="Place description text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $office->s_office_desc_en;?></textarea>
                    ...
                    <div class="form-group">
                        <div class='col-lg-12 col-md-12'>
                            <div class='box'>
                                ...
                                <div class='box-body pad'>
                                    <textarea name="o_desc_id" class="textarea" placeholder="Masukkan deskripsi disini" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $office->s_office_desc_id;?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="form-group">
                 <div class="col-md-4">
                                    ...
                                    <?php foreach($images as $image):?>
                                        <a href="<?php echo base_url();?>uploads/office/image/<?php echo $image->s_picture;?>"><?php echo $image->s_picture;?></a>
                                    <?php endforeach;?>
                                    </p>
                            </div>                
            </div>
