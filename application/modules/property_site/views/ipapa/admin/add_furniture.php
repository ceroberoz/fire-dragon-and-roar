            ...
            <?php
             ...
             echo form_open_multipart('admin/furniture/do_add_furniture', $misc);?>
...
if (selectValues == 0){
var msg = "<select name=\"city_id\" class='form-control' disabled><option value=\"Select Category First\">Select Category First</option></select>";
$('#city').html(msg);
}else{
