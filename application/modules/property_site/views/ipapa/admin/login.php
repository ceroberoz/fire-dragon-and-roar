...
<html class="bg-black">
    ...
    <body class="bg-black">
        <div class="form-box" id="login-box">
            <div class="header">Ipapa Developer Team</div>
            <form action="<?php echo base_url();?>index.php/auth/login" method="post">
                <div class="body bg-gray">
                    <div class="form-group">
                        <input type="text" name="identity" class="form-control" placeholder="username@ipapa.co.id"/>
                    </div>
                    <div class="form-group">
                ...
                <div class="footer">                                                               
                    ...
                    <p><a href="<?php echo base_url();?>index.php/forgot_password">I forgot my password</a></p>
                </div>
            </form>
        </div>
