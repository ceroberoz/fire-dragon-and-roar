            ...
            <?php
             ...
             echo form_open_multipart('admin/decoration/do_edit_decoration', $misc);
             foreach($decorations as $furniture):

            echo form_hidden('fid',$furniture->pk_decoration_id);
             ?>
                <div class="block-inner ">
                  <div class="form-group box-body">
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        <input value="<?php echo $furniture->s_decoration_name;?>" name="f_name" type="text" class="form-control" placeholder="Input Product ID">
                      </div> 
                      </div>
                    </div>
