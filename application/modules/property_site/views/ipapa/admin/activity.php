    ...
    <?php if($this->uri->segment(4)=='today'){ ?>
    ...
    <?php endforeach;?>
    <?php }elseif($this->uri->segment(4)=='yesterday'){ ?>
    ...
    <?php endforeach;?>
    <?php }elseif($this->uri->segment(4)=='week'){ ?>
    <?php foreach($week as $log):?>
                                            <tr>
                                                <td class="small-col"><input type="checkbox" /></td>
                                                <td><?php echo $log->s_username;?></td>
                                                <td><?php echo $log->s_ip_address;?></td>
    ...
    <?php endforeach;?>
    <?php }elseif($this->uri->segment(4)=='month'){ ?>
    <?php foreach($month as $log):?>
                                            <tr>
                                                <td class="small-col"><input type="checkbox" /></td>
                                                <td><?php echo $log->s_username;?></td>
                                                <td><?php echo $log->s_ip_address;?></td>
    ...
    <?php endforeach;?>
    <?php }else{?>
    <?php if($this->uri->segment(3)=='activity'){?>
