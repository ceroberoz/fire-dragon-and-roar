...
class Building extends CI_Controller{
	...
	function map(){
		...
		//$data['building2'] =  $this->ipapa->getBuildingMap2();
		
		$this->load->view('ipapa/frontpage/head');
		//$this->load->view('ipapa/frontpage/header');
		$this->load->view('ipapa/frontpage/search-advance-map',$city);
		$this->load->view('ipapa/frontpage/search-map',$data);
		//$this->load->view('ipapa/frontpage/footer');
	}
	
	function printpdf(){
		$this->load->view('ipapa/frontpage/print');
	}
	...
	function location(){
		...
		$rows = $this->db->get('building');
		//
		$config['base_url'] = base_url().'building/location';
		$config['total_rows'] = $rows->num_rows();
		$config['uri_segment'] = 3;
	    $config['per_page'] = 9;
	    //$config['num_links'] = 5;
	    ...
	    $page = ($this->uri->segment(3)) ? $this->uri->segment(3) : 0;    
	    $data['pagination'] = $this->pagination->create_links();
		$data['building'] = $this->ipapa->getCompareLocation($config['per_page'],$page);
		//$city['option_province'] = $this->mChain->getprovince();
		$sata['buildings'] = $this->ipapa->getBuildingAdmin();
		$city['option_country'] = $this->mhomebase->getcity();
	...
	function price(){
		...
		$rows = $this->db->get('building');
		//
		$config['base_url'] = base_url().'building/price';
		$config['total_rows'] = $rows->num_rows();
		$config['uri_segment'] = 3;
	    $config['per_page'] = 9;
	    //$config['num_links'] = 5;
	    ...
	    $page = ($this->uri->segment(3)) ? $this->uri->segment(3) : 0;    
	    $data['pagination'] = $this->pagination->create_links();
		$data['building'] = $this->ipapa->getComparePrice($config['per_page'],$page);
		//$city['option_province'] = $this->mChain->getprovince();
		$sata['buildings'] = $this->ipapa->getBuildingAdmin();
		$city['option_country'] = $this->mhomebase->getcity();
