...
class Search extends CI_Controller{
	public function __construct(){
		...
		$this->load->model(array('ipapa','mChain','msearch','madvancesearch','mhomebase'));
	}
	...
	public function index(){
		...
		$this->load->view('ipapa/frontpage/search-list-default');
			...
			if (!$keywords) {
					...
					if ($district != "0") {
						if ($area != "0") {
							...
							if($radio=="building") {
								$this->load->view('ipapa/frontpage/head');
								$this->load->view('ipapa/frontpage/header');
								$this->load->view('ipapa/frontpage/search-advance',$data);
								$this->load->view('ipapa/frontpage/search-list-result',$data);
								$this->load->view('ipapa/frontpage/footer');
							}else{
				...
				if ($city != "0") {
					if ($district != "0") {
						...
						if($radio=="building") {
							//redirect("search/keyword/".$keywords."/".$city);
							$this->load->view('ipapa/frontpage/head');
							$this->load->view('ipapa/frontpage/header');
							$this->load->view('ipapa/frontpage/search-advance',$data);
							$this->load->view('ipapa/frontpage/search-list-result',$data);
