...
class Home extends CI_Controller{
	...
	public function index(){
		...
		$data['posting'] 	= $this->mblog->get_posting($config['per_page'],$page);
	    $data['pagination'] = $this->pagination->create_links();	
		$data['archives'] 	= $this->mblog->get_archives();
		
		$this->load->view('ipapa/blog/frontpage/header',$data);
		$this->load->view('ipapa/blog/frontpage/home',$data);
	...
	function archives() {
		...
		$config['base_url'] = base_url().'blog/home/archives/'.$tgl;
		$config['total_rows'] = $rows->num_rows();
	    $config['per_page'] = 3;
		...
		$this->load->view('ipapa/blog/frontpage/header',$data);
		$this->load->view('ipapa/blog/frontpage/archive',$data);
		$this->load->view('ipapa/blog/frontpage/footer');
	}
}