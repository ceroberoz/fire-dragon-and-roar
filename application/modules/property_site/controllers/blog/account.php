...
class Account extends CI_Controller{
	...
	function index(){
		...
		$this->load->view('ipapa/blog/admin/header',$data);
		$this->load->view('ipapa/blog/admin/nav');
		$this->load->view('ipapa/blog/admin/account',$data);
	...
	function edit(){
		...
		$this->load->view('ipapa/blog/admin/header',$data);
		$this->load->view('ipapa/blog/admin/nav');
		$this->load->view('ipapa/blog/admin/edit_account',$data);
	}
}
